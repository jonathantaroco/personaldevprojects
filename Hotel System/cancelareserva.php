...
$sql = "SELECT reserva.id_reserva, reserva.data_inicio, reserva.data_fim, reserva.estado, quartos.tipo, reserva.preco, hoteis.nome, hoteis.cidade
		...
		WHERE reserva.id = quartos.id AND reserva.cpf = '$cpf' AND quartos.cnpj = hoteis.cnpj AND reserva.estado='reservado'
...
?>
<form method="post" action="cancelandoreserva.php">
