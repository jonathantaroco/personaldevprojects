...
<?php
$cpf = $_SESSION['cpf'];
$sql = "SELECT reserva.id_reserva, reserva.data_inicio, reserva.data_fim, reserva.estado, quartos.tipo, quartos.preco, hoteis.nome, hoteis.cidade
		FROM reserva, quartos, hoteis
		WHERE reserva.id = quartos.id AND reserva.cpf = '$cpf' AND quartos.cnpj = hoteis.cnpj
		ORDER BY reserva.data_inicio ";
