...
<form id="formulario" name="signup" method="post" action="totaldeconsultasselecao.php" onsubmit="return validar(this);">
    <?php echo "<h4>Escolha o médico, uma data inicial e uma data final para obter o relatório:</h4>"?>
    <select name='nome'>
        <?php
            $sql = mysql_query ("SELECT cpf, nome FROM usuario WHERE tipousuario = 'Medico'");
