...
<?php
$sql = mysql_query("SELECT cpfmed, data, numero, hora FROM possuiconsulta WHERE cpfpac = '$_SESSION[cpf]'");
echo "<h3>Consultas agendadas</h3>";
while ($registro = mysql_fetch_array($sql)) {
    ...
    if ($sqlquery) {
        ...
        echo "<b>Médico: </b>"; echo $nome; echo "</br>";
        echo "<b>Data: </b>"; echo $data; echo "</br>";
        echo "<b>Hora: </b>"; echo $hora; echo "</br>";
        echo "<b>Consultório: </b>"; echo $numero; echo "</br>";
    } else { echo "erro"; }
}
?>
