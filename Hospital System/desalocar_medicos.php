...
function validar(formulario){
  ...
  if(formulario.numero.value == ''){
    alert("O campo Número do Consultório é obrigatório.");
    return false;
  }     
  return true;
}
...
<div id="menumeiousuario">
    <form id="formulario" name="signup" method="post" action="desalocando_medico.php" onsubmit="return validar(this);">
        ...
        Número do Consultório: <input type="text" name="numero"/><br><br>
...
<?php
$sql = "(SELECT nome, cpf FROM usuario WHERE tipousuario = 'Medico')";
echo "<h3>Médicos do Sistema</h3>";
$consulta = mysql_query($sql);
		while ($registro = mysql_fetch_array($consulta)) {
            echo "______________________"; echo "</br>"; echo "</br>";
            echo "<b>Nome: </b>"; echo $registro['nome']; echo "</br>";
		}
?>
</div>
<div id="rodape">
