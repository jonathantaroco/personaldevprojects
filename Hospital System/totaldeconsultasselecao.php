...
function failed(){
	setTimeout("window.location='totaldeconsultas.php'", 2000);
}
</script>
</head>
...
$sql = mysql_query("SELECT * FROM atende WHERE cpfmed = '$cpf' AND (data BETWEEN '$datainicio' AND '$datafim')");
$rows = mysql_num_rows($sql);
echo "<h3>Número de consultas entre $datainicio e $datafim: $rows</h3>";
if ($rows > 0) {
