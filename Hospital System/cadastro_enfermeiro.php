...
function validar(formulario){
  ...
  if(formulario.coren.value == ''){
    alert("O campo COREN é obrigatório.");
    return false;
  }
  if(formulario.espenf.value == ''){
...
<div id="menumeiousuario">
    <form id="formulario" method="post" action="cadastrando_enfermeiro.php" onsubmit="return validar(this)";>
	   CPF: <input type="text" name="cpfenf"/><br></br>
       ...
       COREN: <input type="text" name="coren"/><br></br>
       Especialização Médica: <input type="text" name="espenf"/><br></br>
